...
/* Base and Prefix Prior to LANGTAG because the are equivalent --base and prefix are no longer legal langtags--
*/
%%
%{
	/* blah */
...
<YYINITIAL> [^\x20|\x09|\x0D|\x0A] { /* unmatchable Character */ return $this->createToken(SparqlPHPParser::TK_FAIL); }
